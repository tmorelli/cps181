...
public class Grades{
	...
	public void printLowestForEachStudent(){
		...
		for (int x =0; x< numStudents;x++ ){
			...
			for (int y = 0; y < numGrades; y++){
				...
				if(nameGrades[x].getGrades()[y] < personalLow){
					
					personalLow = nameGrades[x].getGrades()[y];
				}
			}
			System.out.println(nameGrades[x].getStudentName() + " Lowest Grade: " + personalLow);
		}
		
		System.out.println("");
	}//end printLowestForEachStudent
	...
	public void printHighestForEachStudent(){
		...
		for (int x =0; x< numStudents;x++ ){
			...
			for (int y = 0; y < numGrades; y++){
				...
				if(nameGrades[x].getGrades()[y] > personalHigh){
					
					personalHigh = nameGrades[x].getGrades()[y];
				}
			}
			System.out.println(nameGrades[x].getStudentName() + " Highest Grade: " + personalHigh);
		}
		System.out.println("");
	}//end printHighestForEachStudent
	...
	public void printAverageScoreForEachStudent(){
		...
		for (int x =0; x< numStudents;x++ ){
			...
			System.out.println(nameGrades[x].getStudentName() + " Average Score: " + sum);
		}
		System.out.println("");
	}//end printAverageScoreForEachStudent
