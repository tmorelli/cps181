...
public class Grades<nameGrades> {
	/**
	 * @ author Tony Morelli
	 * 
	 * @throws None
	 * 
	 *             Date: 20 February 2014 Purpose: Handles Grade related data
	 *             Uses:
	 * 
	 */
	...
	public void printLowestScore(){
		for (int x=0;x<numStudents;x++){
			...
			//I'm trying to print the lowest score out of the array but I
			//can't figure out how to find the lowest grades.
		}
		public void printHighestScore(){
			for (int x=0;x<numStudents; x++ ){
				for (int y=o; y=numGrades; y++){
					System.out.println(nameGrades[x]);
				}
			}
			public void printAverageScore(){
				...
				//the average score is numStudent/numgrades
				//
}