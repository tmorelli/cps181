...
public class Grades { 
	...
	public void printLowestScore(){
		...
		System.out.println("Lowest grade for the class is " +low);
	}
	...
	public void printHighestScore(){
		...
		System.out.println("Highest grade for the class is " +high);
	}
	...
	public void printAverageScore(){
		...
		avg = total/(numStudents * numGrades);
		System.out.println("Average Grade for the class is" + avg );
	...
	public void printLowestForEachStudent(){
		...
		for(int x=0; x< numStudents;x++){
			...
			System.out.println("Lowest grade for " +nameGrades[x].getStudentName() + " is " +low);
		}
	...
	public void printHighestForEachStudent(){
		...
		for(int x=0; x< numStudents;x++){
			...
			System.out.println("Highest grade for " + nameGrades[x].getStudentName() +" is " +high);
		}
	}
	...
	public void printAverageScoreForEachStudent(){
		...
		avg = total/(numGrades);
		System.out.println("Average Grade for " + nameGrades[x].getStudentName() + " is " + avg );
		}
	}
